...
export default function ReleaseList({
  ...
  useEffect(() => {
    ...
    const url = `${base}/api/releases?product=${product}`;
    fetch(url)
      .then(async (r) => setIndex(await r.json()))
      .catch(() => setIndex({ product, releases: [] } as ReleasesIndex));
  }, [product]);
              ...
              <div className="col-span-12 md:col-span-8">
                <div className="flex items-start justify-between gap-4">
                  <div className="relative group">
                    ...
                    <h2 className="text-2xl font-semibold m-0">{r.title}</h2>
                  </div>
                </div>
                <div className="mt-3 prose dark:prose-invert max-w-[110ch] break-words prose-pre:overflow-visible prose-pre:whitespace-pre-wrap prose-img:max-w-full">
                  <ReactMarkdown>
